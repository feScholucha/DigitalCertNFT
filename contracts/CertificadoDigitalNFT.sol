...
/**
 * @title CertificadoDigitalNFT
 * @dev Contrato final para emissão de certificados como NFTs.
 */
contract CertificadoDigitalNFT is ERC721URIStorage, Ownable {
    ...
    /**
     * @dev O construtor define o nome, símbolo e o dono inicial (instituição).
     */
    ...
    /**
     * @dev Função principal para emitir um novo certificado.
     * Restrita apenas ao dono do contrato (a instituição).
     * @param para O endereço da carteira do aluno.
     * @param tokenURI O link para os metadados do certificado (ex: IPFS).
     */
